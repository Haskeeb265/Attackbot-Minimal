"""github-endpoints — endpoint enumeration via GitHub code search (gwen001).
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tool_github_endpoints.py <target-domain>")
        sys.exit(2)
